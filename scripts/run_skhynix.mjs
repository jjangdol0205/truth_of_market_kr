    ...
    **OUTPUT JSON STRUCTURE:**
    ...
    for (const modelName of modelsToTry) {
        try {
            ...
            const jsonFilename = `skhynix_${reportType}_q4_2025.json`;
            const mdFilename = `skhynix_${reportType}_q4_2025.md`;
...
async function main() {
    console.log("Starting SK Hynix Deep Research & Earning Guidance...");
    const tickerName = "SK하이닉스"; 
    const numericTicker = "000660"; 
